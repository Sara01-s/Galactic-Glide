...
public sealed partial class AudioController {
	...
	private readonly string _musicPath    = "Audio/Clips/Music/";
	private readonly string _ambiencePath = "Audio/Clips/Ambience/";
	private readonly string _sfxPath      = "Audio/SFX/";
